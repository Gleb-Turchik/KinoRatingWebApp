...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2016-07-22 07:57:35',NULL),('diagnostics.include_raw','OFF','2016-07-22 07:57:35',NULL),('ps_thread_trx_info.max_length','65535','2016-07-22 07:57:35',NULL),('statement_performance_analyzer.limit','100','2016-07-22 07:57:35',NULL),('statement_performance_analyzer.view',NULL,'2016-07-22 07:57:35',NULL),('statement_truncate_len','64','2016-07-22 07:57:35',NULL);
...
-- Dump completed on 2018-01-30 19:36:57
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
...
INSERT INTO `comment` VALUES (146,1,2,'wow wow  moderated','2016-08-28 02:52:10.4'),(149,1,4,'второй коммент\r\nd','2016-08-28 10:59:52.0'),(154,1,3,'123','2016-08-30 20:17:03.0'),(155,1,5,'jgjgv\r\n\r\n,b,n','2016-08-30 23:42:58.0'),(156,1,5,'','2016-08-30 23:43:49.0'),(168,2,1,'Привет ','2016-09-01 14:54:14.0'),(171,1,7,'павпот','2016-09-02 13:39:15.0'),(172,1,8,'ыапыаир','2016-09-02 13:43:34.0'),(174,2,10,'dfxbdsfbsd','2016-09-08 16:21:14.0'),(175,2,3,'adawd','2016-09-12 16:27:52.0');
...
INSERT INTO `country` VALUES (1,'США'),(2,'Индия'),(3,'РФ'),(4,'Франция'),(5,'Великобритания'),(6,'Уругвай');
...
INSERT INTO `film` VALUES (1,'Отряд самоубийц',2016,1,1,118,'Фантастический боевик «Отряд самоубийц» снят по мотивам одноименного комикса DC Comics и повествует о приключениях суперзлодеев, которым пришлось объединить свои усилия ради спасения мира. После исчезновения Супермена правительству необходима новая защита от злодеев, но никто из супергероев не может заменить Супермена. Тогда амбициозная женщина-политик Аманда Уоллер предлагает создать отряд из плохих ребят, способных на что-то хорошее.\r\nКак нельзя лучше для этого отряда подходят заключенные в одной из строжайших тюрьм государства суперзлодеи: Дэдшот, Джокер, Харли Квинн, Рик Флэг, Капитан Бумеранг, Эль Диабло и другие. Именно суперзлодеи становятся новым спасением в виде «Отряда Х», который создали с целью проведения самых опасных миссий. Правда злодеи быстро переименовали себя в «Отряд самоубийц», ведь такое название куда лучше подходит для их новой деятельности.  ','7xLCggrIRHY','Дэвид Эйер','Марго Робби, Уилл Смит, Бен Аффлек'),(2,'Иллюзия обмана 2',2016,1,9,129,'Еще совсем недавно героев фильма «Иллюзия обмана 2» — легендарную четверку талантливых фокусников, известную, как «Четыре всадника», называли робингудами современности, так как на своих шоу ребята проворачивали невероятные по масштабам аферы. Они вскрывали самые надежные банки в мире и дарили деньги зрителям, а агентам ФБР так и не удалось поймать иллюзионистов. Последнее дело вынудило ребят «залечь на дно», но спустя несколько лет Джей, Мерритт и Джек снова возвращаются с новым шоу. Правда на этот раз их партнершу Хенли заменяет не менее талантливая Лула. Однако лучшие иллюзионисты мира не ожидали, что у них появится очень мощных врагов в лице сына разоренного Артура Тресслера, Уолтера и томящегося в тюрьме разоблачителя иллюзионистов Таддеуша Брэдли. На этот раз магия будет настолько ошарашивающей, что поставит в тупик даже «Четырех всадников».  ','nAUsMOS-sA4','Джон Чу','Марк Руффало, Вуди Харрельсон, Джесси Айзенберг'),(3,'Механик',2016,1,1,110,'Очередной триллер про наемных профессиональных убийц, «Механик», рассказывает об Артуре Бишопе, профессиональном киллере которому нет равных. Он всегда работает один, холодный и расчетливый, он выполняет самые сложные задания в одиночку. Иногда все должно выглядеть как будто это несчастный случай, и это по настоящему высшее мастерство для таких как он, и прозвище его – Механик. По стечению обстоятельств дальше ему придется работать уже не в одиночку, ему предстоит взять к себе в ученики молодого и горячего парня. И вот они уже работают вместе, устраняют цели, но в один прекрасный момент все обернется так, что убрать им необходимо будет друг друга. Фильм «Механик» создан  в стиле американского боевика на тему наемных убийц, динамичный, эмоциональный и захватывающий экшн. И как говорят многие критики, после просмотра эмоции будут только положительные, вот и посмотрим…   ','IrpgcgGrv5Y','Саймон Уэст','Джейсон Стейтем'),(4,'Парни со стволами',2016,1,2,114,'В центре сюжета фильма «Парни со стволами» — реальная история из жизни двух простых  американских парней, которым удалось сорвать нереальный джекпот у судьбы. Еще недавно 22-летний Дэвид Пакоз работал массажистом в одном из салонов солнечного Майами и мечтать не смел о больших деньгах и сумасшедших возможностях. Вместе со школьным другом Эфраимом Дивероли он организовывает компанию, которая занимается продажами крайне ценными товарами. \r\n\r\nУловив, что правительство не может сотрудничать с некоторыми людьми напрямую по продаже оружия, ребята становятся прекрасными посредниками и в итоге заключают с Пентагоном контракт на триста миллионов долларов. Так начинается новая шикарная жизнь друзей, а также невероятные, опасные и самые незабываемые приключения парней со стволами.  ','vLZRLgqu5-0','Тодд Филлипс','Джона Хилл, Брэдли Купер'),(5,'Не дыши',2016,1,8,88,'Грабители забираются в дом одинокого слепого старика с целью украсть огромную сумму, которая, по слухам, спрятана где-то внутри. Казалось бы — что может быть проще, чем вынести деньги из дома практически беспомощного человека. Но они жестоко ошибаются: преследуемый становится преследователем. И тайна, которую он хранит, гораздо страшнее, чем обычные пенсионные накопления.','sKYOXKu528E','Федерико Альварес','Стивен Лэнг'),(6,'Великолепная семерка',2016,1,1,132,'В маленькой деревушке крестьяне годами страдают от бесчинств местных бандитов. Их главарь Калвера держит в страхе всю округу, мучая ее жителей постоянными поборами и наказаниями. И однажды крестьяне решают нанять себе защитников — семерых вооруженных всадников во главе с бритоголовым Крисом.\r\n\r\nВеликолепная семерка быстро наводит порядок, но Калвейре все же удается бежать. И тогда поимка злодея и его соратников становится делом чести великолепной семерки.','uQEh4swLlkI','Антуан Фукуа','Дензел Вашингтон, Итан Хоук'),(7,'Крейсер',2016,1,1,210,'Лето 1945 года. До конца Второй мировой оставались считанные недели… Крейсер ВМС США «Индианополис» доставил на американскую военную базу на острове Тиниан боеголовку атомной бомбы. На обратном рейде корабль был торпедирован японцами и пошел ко дну. «SOS!» капитана Маквэя не был услышан. И живые позавидовали мертвым: палящее солнце и зубы акул, жажда и галлюцинации, безумие и адские муки отчаяния…','BoSf-m_eack','Марио Ван Пиблз','Николас Кейдж'),(8,'Аисты',2016,1,11,140,'Аисты приносят детей… или, во всяком случае, раньше приносили. Теперь же они занимаются доставкой посылок для огромного сайта интернет-продаж. Джуниор, лучший аист в курьерской компании, должен пойти на повышение, но он случайно активирует машину для создания детей и получает очаровательную, но совершенно незапланированную девочку.\r\n\r\nПытаясь доставить эту «посылку» до того, как босс узнает о произошедшем, Джуниор и его подруга Лютик, единственный человек на Горе Аистов, решаются на свою первую доставку ребёнка и отправляются в безумное и насыщенное удивительными открытиями приключение, благодаря которому многие семьи могут стать полными, а аисты — вернуться к своей истинной миссии на Земле.','ZzYGcJptAxs','Николас Столлер, Даг Свитлэнд','дети :)'),(9,'Девять',2009,1,11,80,'Человек создал искусственный разум, но не смог дать механизму душу. И однажды его творение подняло руку на своего создателя…\r\n\r\nВ страшной войне человечество было уничтожено механическими монстрами. Перед тем как погибнуть, профессор, придумавший умные машины, сшил девять тряпичных кукол, вложив в них человеческие души. Девять Героев. Девять Характеров. Только вместе, помогая друг другу, им суждено выжить. Выжить, чтобы выполнить свою миссию…','_qApXdc1WPY','Шэйн Экер','дети :)'),(10,'Багровый пик',2015,1,8,120,'Дурная слава преследует дом, что возвышается над городом. С приходом зимы он утопает в кровавых снегах. Говорят, дело в глине, проступающей на поверхность. Но ни единая душа не рискует ступить на ледяной склон… кроме нее. Она влюблена в таинственного незнакомца, живущего в древних стенах со своей сестрой. Багровый пик пробудился и уже не уснет.','G0zEIfIYAQ0','Гильермо дель Торо','Миа Васиковска, Джессика Честейн, Том Хиддлстон');
...
INSERT INTO `genre` VALUES (1,'боевик'),(2,'комедия'),(3,'драмма'),(4,'фантастика'),(5,'приключения'),(6,'сериал'),(7,'триллер'),(8,'ужасы'),(9,'детектив'),(10,'исторический'),(11,'мультфильм'),(12,'документальный');
...
INSERT INTO `user` VALUES (1,'Глеб','turchik','admin@admin.ru','1',1,1),(2,'Диана','Вайтович','user@user.ru','1',2,0),(3,'диана','Вайтович','glebturchik@gmail.com','queeseso12',2,0);
...
-- Dump completed on 2018-01-30 19:36:58
