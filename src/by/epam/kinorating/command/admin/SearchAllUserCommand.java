 ...
 */
public class SearchAllUserCommand implements Command {
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            ...
            LOG.error("Exception occurred while getting users from db " + e.getMessage());
            String errmessage = MessageManager.getMessage(Message.MESSAGE_USER_LIST, locale);
            request.setAttribute(Attribute.ATTRIBUTE_ERR_MESSAGE, errmessage);
            return PagePath.PAGE_INFO;
        }
        request.setAttribute(Attribute.ATTRIBUTE_USERS, list);
