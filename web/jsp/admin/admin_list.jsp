        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <c:choose>
                <c:when test="${not empty requestScope.users}">
                    <jsp:include page="_list_user.jsp"/>
                </c:when>
                <c:when test="${not empty requestScope.films}">
                    <jsp:include page="_list_film.jsp"/>
                </c:when>
                <c:when test="${not empty requestScope.countries}">
                    <jsp:include page="_list_country.jsp"/>
                </c:when>
                <c:when test="${not empty requestScope.genres}">
                    <jsp:include page="_list_genre.jsp"/>
                </c:when>
                <c:when test="${not empty requestScope.comments}">
                    <jsp:include page="_list_comment.jsp"/>
                </c:when>
            </c:choose>
